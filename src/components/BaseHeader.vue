    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid md-flex">
            <div class="left-container">
                <button type="button" class="btn d-none d-lg-block">
                    <i class="bi bi-three-dots-vertical text-white"></i>
                </button>
                <button type="button" class="btn d-md-block d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li style="border-bottom: 1px #ccc solid;"><a class="dropdown-item" href="#">Something else
                                        here</a></li>
                                <li class="mt-1"><a class="dropdown-item" href="#">Login out</a></li>
                            </ul>
                        </div>
                    </li>
