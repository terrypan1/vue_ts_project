...
const imageLoaded = (index: number) => {
    ...
    rooms.value[index].isLoaded = true;
};
onMounted(() => {
                                                    ...
                                                    <li class="w-100 mb-2"
                                                        ...
                                                        <div v-show="room.show">
                                                            ...
                                                            <div class="d-flex mb-3 ms-2 justify-content-around">
                                                                ...
                                                                <div>
                                                                    浴缸<input type="checkbox"
                                                                        v-model="room.equipment.bathtub">
                                                                </div>
                                                                <div>
                                                                    早餐<input type="checkbox"
                                ...
                                <div class="col-md-9">
                                    <div class="container-fuild">
                                        <div class="row">
                                            ...
                                            <hr>
                                            <div class="col-lg-4" v-for="(room,index) in finalPrices" :key="room.id">
                                                <BaseBlock :show="cardPrice.show">
                                                    <template #content>
                                                        <!-- <img src="/assets/imgs/bedroom1.png" alt="" @load="imgtest"> -->
                                                        <div class="priceCalculator-img-container">
                                                            <div v-if="!room.isLoaded" class="div-img-placeholder"></div>
                                                            <img :src="`/assets/imgs/${room.path}`" alt="" @load="() => imageLoaded(index)" class="img-fluid" v-show="room.isLoaded">
                                                        ...
                                                        <span style="font-size: 12px;font-weight: 900;">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" height="14" width="14"
                                                                v-if="room.equipment.bathtub" class="ms-1"
                                                                viewBox="0 0 512 512">
                                                            ...
                                                            <i class="bi bi-cup-hot ms-1"
                                                                v-if="room.equipment.breakfast"></i>
                                                        </span><br>
                                                        <span>0.8*{{ room.discount }} = {{ room.finalDiscount }}折</span>
                                                        <h5>TWD
                                                            <span style="text-decoration: line-through;">{{ room.price
                                                            }}</span>
...
.priceCalculator-img-container {
    position: relative;
    width: 100%;
    padding-top: 56.25%; /* 16:9 比例，可以根據需要調整 */
    overflow: hidden;
}
